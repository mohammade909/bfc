...
<div className="mx-5 sm:mx-2">
  <div className="w-full lg:flex flex-col md:flex-row justify-between items-center mb-3 lg:pl-3">
    <div>
      ...
      <p className="text-slate-400 text-sm">Overview of the Transfer History.</p>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th className="p-4 border-b border-slate-200 bg-black w-56">
              <p className="text-sm font-normal leading-none text-white">Description</p>
            </th>
            <th className="p-4 border-b border-slate-200 bg-black w-56">
              <p className="text-sm font-normal leading-none text-white">At</p>
            </th>
          </tr>
        </thead>
