...
export default function Footer() {
  return (
    ...
    //         Trade with confidence and ease at JastroFX. We are here to help you grow your investments every step of the way.
    //         </p>
    ...
    //         <h4 className="text-lg text-gray-600 font-medium mb-7">Services</h4>
    ...
    //         <h4 className="text-lg text-gray-600 font-medium mb-7">
    //         Support
    //         </h4>
    //         <ul className="text-gray-800 transition-all duration-500 text-base ">
    //           <li className="mb-6">
    ...
    //       {/*End Col*/}
    //       <div className="w-full  lg:mt-0 mt-8  lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
    //         <h4 className="text-lg  text-gray-600 font-medium mb-7 lg:text-left">
    //           Newsletter
    //         </h4>
    ...
    //     </div>
    //     {/*Grid*/}
    //     <div className="py-7 border-t border-gray-600">
    //       <div className="flex items-center justify-center flex-col ">
    //         <span className="text-sm text-gray-800 ">
    //           ©<a href="https://pagedone.io/"> 2024 bot.</a> All rights reserved.
    //           reserved.
    //         </span>
  ...
  <div className="container px-6 py-8 mx-auto">
    <div className="flex flex-col items-center text-center">
      ...
      <div className="flex flex-wrap justify-center mt-6 -mx-4">
        ...
        <Link to="/contact" className="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Contact </Link>
        <Link to="/terms" className="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Teams </Link>
