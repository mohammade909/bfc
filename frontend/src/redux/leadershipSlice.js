...
export const getAllLeadership = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await fetch("https://api.jastrobot.com/api/v1/leadership/list");
...
export const getAllLeadershipByid = createAsyncThunk(
  ...
  async ({user_id}, thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/leadership/by/${user_id}`)
...
export const deleteleadership = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      const response = await fetch(`https://api.jastrobot.com/api/v1/leadership/${id}`, {
        method: "DELETE",
      });
