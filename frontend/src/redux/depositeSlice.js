...
//     try {
//       console.log(values)
//       const response = await fetch(`https://api.jastrobot.com/api/v1/deposite/add`, {
//         method: "POST",
//         headers: {
...
export const getAllDeposite = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await fetch("https://api.jastrobot.com/api/v1/deposite/list");
...
export const getAllDepositeByid = createAsyncThunk(
  ...
  async (user_id, thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/deposite/by/${user_id}`)
...
export const deleteDeposite = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      const response = await fetch(`https://api.jastrobot.com/api/v1/deposite/${id}`, {
        method: "DELETE",
      });
