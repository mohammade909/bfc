...
export const getReferralTree = createAsyncThunk(
  ...
  async (referral_code, thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/referral/list/${referral_code}`);
...
export const getTreeData = createAsyncThunk(
  ...
  async (referral_code, thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/referral/full/${referral_code}`);
