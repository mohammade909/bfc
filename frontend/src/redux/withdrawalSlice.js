...
export const addWithdrawal = createAsyncThunk(
  ...
  async ({ values }, thunkAPI) => {
    try {
      console.log(values)
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/add`, {
        method: "POST",
        headers: {
...
export const addROIWithdrawal = createAsyncThunk(
  ...
  async ({ values }, thunkAPI) => {
    try {
      console.log(values)
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/add/roiwithdrawal`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const addCompoundWithdrawal = createAsyncThunk(
  ...
  async ({ values }, thunkAPI) => {
    try {
      console.log(values)
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/addcompoundwithdrawal`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const getAllWithdrawal = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await fetch("https://api.jastrobot.com/api/v1/withdrawalrequest/list");
...
export const getAllWithdrawalByid = createAsyncThunk(
  ...
  async (user_id, thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/by/${user_id}`)
...
export const deleteWithdrawal = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/${id}`, {
        method: "DELETE",
      });
...
export const compoundAmount = createAsyncThunk(
  ...
  async ({ values }, thunkAPI) => {
    try {
      console.log(values)
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/compound/amount`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
...
export const updateROIWithdrawal = createAsyncThunk(
  ...
  async ({  id, status,amount,user_id }, thunkAPI) => {
    try {
      // Your asynchronous logic to update student here
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/update/roi/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
...
export const updateCompoundWithdrawal = createAsyncThunk(
  ...
  async ({  id, status,amount,user_id }, thunkAPI) => {
    try {
      // Your asynchronous logic to update student here
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/compound/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
...
export const debitAmount = createAsyncThunk(
  ...
  async (values, thunkAPI) => {
    try {
        console.log( values)
      // Your asynchronous logic to update student here
      const response = await fetch(`https://api.jastrobot.com/api/v1/withdrawalrequest/debit`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
