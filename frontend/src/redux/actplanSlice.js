...
export const addActPlan = createAsyncThunk(
  ...
  async ({ values }, thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/actplan/add`, {
        method: "POST",
        headers: {
...
export const getAllActPlan = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await fetch("https://api.jastrobot.com/api/v1/actplan/list");
...
export const getActPlan = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/actplan/${id}`);
