...
export const transfertouser = createAsyncThunk(
  ...
  async ({values} , thunkAPI) => {
    try {
      console.log(values)
      const response = await fetch(`https://api.jastrobot.com/api/v1/transfer/touser`, {
        method: "POST",
        headers: {
...
export const FriendTopup = createAsyncThunk(
  ...
  async ({values} , thunkAPI) => {
    try {
      console.log(values)
      const response = await fetch(`https://api.jastrobot.com/api/v1/transfer/friend`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const getTransfer = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await fetch("https://api.jastrobot.com/api/v1/transfer/list");
...
export const getTransferById = createAsyncThunk(
  ...
  async (user_id , thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/transfer/byid/${user_id}`, {
