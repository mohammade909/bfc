...
export const addPlan = createAsyncThunk(
  ...
  async ({ values }, thunkAPI) => {
    try {
      ...
      const response = await fetch(`https://api.jastrobot.com/api/v1/plans/add`, {
        method: "POST",
        headers: {
...
export const addactivelevel = createAsyncThunk(
  ...
  async ({ values }, thunkAPI) => {
    try {
      console.log(values)
      // Your asynchronous logic to update student here
      const response = await fetch(`https://api.jastrobot.com/api/v1/plans/addactivelevel`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const addinvestlevel = createAsyncThunk(
  ...
  async ({ values }, thunkAPI) => {
    try {
      console.log(values)
      // Your asynchronous logic to update student here
      const response = await fetch(`https://api.jastrobot.com/api/v1/plans/addinvestlevel`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const getAllPlans = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await fetch("https://api.jastrobot.com/api/v1/plans/list");
...
export const getPlan = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/plans/${id}`);
