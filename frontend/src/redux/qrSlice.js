...
export const addQrLink = createAsyncThunk(
  ...
  async (values , thunkAPI) => {
    try {
      const response = await fetch(`https://api.jastrobot.com/api/v1/qr/add`, {
        method: "POST",
        headers: {
...
export const getQrLink = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await fetch("https://api.jastrobot.com/api/v1/qr");
...
export const deleteQrLink = createAsyncThunk(
  ...
  async (id, thunkAPI) => {
    try {
      ...
      const response = await fetch(`https://api.jastrobot.com/api/v1/qr/${id}`, {
        method: "DELETE",
      });
